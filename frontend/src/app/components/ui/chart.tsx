...
const ChartTooltip = RechartsPrimitive.Tooltip as unknown as React.ElementType;
...
const ChartLegend = RechartsPrimitive.Legend as unknown as React.ElementType;
